...
class InstructorSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $instructors = [
            ...
            ['name' => 'Cortas, Faustino', 'department_id' => 6],
            ['name' => 'Geronaga, Pinkie M.', 'department_id' => 6],
        ...
        foreach ($instructors as $instructor) {
            $randomEmail = strtolower(Str::random(6)) . '@example.com';
            $teachers[] = [
